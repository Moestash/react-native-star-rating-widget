...
const StarRating = ({
  ...
  }, [rating, internalRating, maxStars, onChange, enableSwiping, onRatingStart, onRatingEnd, animationConfig.delay, step, multiplier, fullFraction, snap]);
  ...
  }), (0, _utils.getStars)(internalRating, maxStars).map((fill, i) => {
